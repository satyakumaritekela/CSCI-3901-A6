...
alter table orders add constraint checkNumber foreign key(checkNumber) references payments(checkNumber);
...
alter table orders 
	...
	add checkNumber varchar(50) not null,
	add orderStatus varchar(15) not null,
    add foreign key(checkNumber) references payments(checkNumber);
